        ...
        <h2 class="tooltip-block">
            ...
            <vTooltip
                    :text="`Кешбэк может быть перечислен Вам одним из двух способов:<br>
                            ...
                            - на банковскую карту одного из более чем 200 российских банков. Карта должна быть прикреплена к указываемому телефонному номеру.<br>
                            Срок выплаты кешбэка - в течение 7 дней после оплаты счета.`"
            />
        </h2>
