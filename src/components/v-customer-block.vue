            ...
            <div class="autonext  tooltip-block">
                ...
                <vTooltip
                        :text="`При активации данной опции к Вашим следующим заказам будет применяться этот же способ перечисления кешбэка,
                                ...
                                Однако Вы всегда сможете изменить способ перечисления для каждого конкретного заказа.
                                Ссылки для редактирования заказов будут приходить на указанную здесь почту.`"
                />
            </div>
            <div class="pass tooltip-block">
                ...
                <vTooltip
                        :text="`После установки пароля только Вы будете иметь доступ к данной странице.
                                ...
                                В случае необходимости восстановления пароля будет использоваться указанная здесь почта.`"
                />
            </div>
        </div>
    </div>
